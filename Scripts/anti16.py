...
Summary:
    Kivy application that displays Antikythera-style planetary rings and
    updates their ecliptic longitudes for a selected UTC date and time.
...
Dependencies:
    ...
    - kivy
    - python-dateutil
    - astronomy-engine, installed from astronomy_local/astronomy_src/source/python

Project layout:
    Scripts/anti16.py
    Rings/ring_moon.png, ring_mercury.png, ring_venus.png, ring_sun.png,
          ring_mars.png, ring_jupiter.png, ring_saturn.png
"""
...
class AntikytheraRings(Widget):
    def __init__(self, **kwargs):
        ...
        self.ring_textures = [
            CoreImage(str(RINGS_DIR / f"ring_{name}.png")).texture
            for name in NAMES
        ]
